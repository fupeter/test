...
/***********************************************************************************************//**
 *  \brief  A new Heart Rate measurement value is available.
 *  \details  This function is called by the HR plugin before sending a measurement value.
 *  \param  hrMeasVal  Measured Heart Rate Value.
 **************************************************************************************************/
void emberAfPluginHrMeasAvailableCallback(uint16_t hrMeasVal)
{}


/***********************************************************************************************//**
 *  \brief  Heart Rate Measurement Notifications have been switched on.
 *  \details  Heart Rate Measurement Notifications have been switched on, the Server will from now
 *  on periodically send Heart Rate measurments to the Client.
 **************************************************************************************************/
void emberAfPluginHrNotificationsOnCallback(void)
{}
...
void emberAfMainEfr32AppInitCallback(void) {
	extern void Midware_RPM_Initial_Data(void);
...
void emberAfMainStackTickCallback(void) {
	extern void Midware_RPM_Process(void);
	extern void systemEnterSleept(void);
	systemEnterSleept();
	Midware_RPM_Process();
}
